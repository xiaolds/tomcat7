...
CREATE TABLE `t_server_config` (
  ...
  `server_config_pwd_is_expired` int(11) DEFAULT NULL,
  `server_config_pwd_is_expired_date_time` int(11) DEFAULT NULL,
  `server_config_is_pwd_check` int(11) DEFAULT NULL,
  `server_config_pwd_strength` int(50) DEFAULT NULL,
  `server_config_pwd_check_type` int(11) DEFAULT NULL,
  `server_config_lock_backupset_dir` int(50) DEFAULT NULL,
  `server_config_is_start_email_report` int(11) DEFAULT NULL,
  `server_config_mail_id` int(11) DEFAULT NULL,
  `server_config_is_start_sms_report` int(11) DEFAULT NULL,
  ...
  `server_config_create_time` datetime DEFAULT NULL,
